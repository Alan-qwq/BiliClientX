package com.Alan.BiliClientX.adapter.favorite;
...
import com.Alan.BiliClientX.activity.user.favorite.FavoriteVideoListActivity;
import com.Alan.BiliClientX.activity.user.favorite.FavouriteOpusListActivity;
import com.Alan.BiliClientX.model.FavoriteFolder;
            ...
            if (position == folderList.size() + 1) {
                ...
                favoriteHolder.itemView.setOnLongClickListener(view -> {
                    if (onLongClickListener != null && !folder.isDefault) {
                        ...
                        com.Alan.BiliClientX.util.MsgUtil.showMsg("默认收藏夹不能编辑");
                    }
                    return true;
                });
            }
