...
import com.Alan.BiliClientX.BuildConfig;
import com.Alan.BiliClientX.R;
import com.Alan.BiliClientX.activity.update.UpdateInfoActivity;
...
public class AppInfoApi {
    ...
    private static void checkUpdate(Context context, boolean need_toast, boolean debug_ver) {
        try {
            ...
            String url = "https://api.bili.alanqwq.top/terminal/version/get_last";
    ...
    public static String getDownloadUrl(int versionCode) throws Exception {
        String url = "https://api.bili.alanqwq.top/terminal/version/get_download_url" + new NetWorkUtil.FormData().setUrlParam(true)
    ...
    public static void checkAnnouncement() throws Exception {
        String url = "https://api.bili.alanqwq.top/terminal/announcement/get_list?from=" + SharedPreferencesUtil.getInt("app_announcement_last", -1);
        JSONObject result = NetWorkUtil.getJson(url, customHeaders);
    ...
    public static ArrayList<Announcement> getAnnouncementList() throws Exception {
        String url = "https://api.bili.alanqwq.top/terminal/announcement/get_list";
        JSONObject result = NetWorkUtil.getJson(url, customHeaders);
    ...
    public static ApiResult uploadStack(String stack, Context context) {
        //上传崩溃堆栈
        try {
            String url = "https://api.bili.alanqwq.top/terminal/upload/stack";
    ...
    public static int getSponsors(ArrayList<UserInfo> list, int page) throws Exception {
        String url = "https://api.bili.alanqwq.top/terminal/afdian/get_sponsor?page=" + page;
        JSONObject result = NetWorkUtil.getJson(url, customHeaders);
