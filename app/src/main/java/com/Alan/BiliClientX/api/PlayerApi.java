...
import com.Alan.BiliClientX.activity.player.PlayerActivity;
import com.Alan.BiliClientX.activity.settings.SettingPlayerChooseActivity;
import com.Alan.BiliClientX.activity.video.JumpToPlayerActivity;
import com.Alan.BiliClientX.model.DashAudioStream;
import com.Alan.BiliClientX.model.DashData;
import com.Alan.BiliClientX.model.DashVideoStream;
...
import com.Alan.BiliClientX.service.DownloadService;
...
public class PlayerApi {
    ...
    public static java.util.List<com.Alan.BiliClientX.model.ViewPoint> getViewPoints(long aid, long cid) throws JSONException, IOException {
        String url = "https://api.bilibili.com/x/player/wbi/v2?aid=" + aid
                + "&cid=" + cid;
        url = ConfInfoApi.signWBI(url);
        JSONObject data = NetWorkUtil.getJson(url).getJSONObject("data");

        java.util.List<com.Alan.BiliClientX.model.ViewPoint> viewPoints = new java.util.ArrayList<>();
        ...
        if (data.has("view_points")) {
            ...
            for (int i = 0; i < viewPointsArray.length(); i++) {
                ...
                viewPoints.add(new com.Alan.BiliClientX.model.ViewPoint(content, from, to, type, imgUrl, logoUrl));
            }
        }
