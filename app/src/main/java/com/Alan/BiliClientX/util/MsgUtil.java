...
import com.Alan.BiliClientX.activity.DialogActivity;
import com.Alan.BiliClientX.activity.ShowTextActivity;
...
public class MsgUtil {
    ...
    public static void err(String desc, Throwable e) {
        ...
        else if (e instanceof TerminalContext.IllegalTerminalStateException) {
            // 视频/动态/文章不存在的情况
            showMsg("获取信息失败，内容可能不存在或已被删除");
            return;
        } else {
            output.append("错误：");
            output.append(e_str);
