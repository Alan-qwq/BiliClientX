package com.Alan.BiliClientX.activity.live;
...
import com.Alan.BiliClientX.adapter.video.MediaEpisodeAdapter;
import com.Alan.BiliClientX.api.LiveApi;
import com.Alan.BiliClientX.api.PlayerApi;
import com.Alan.BiliClientX.model.Bangumi;
...
public class LiveInfoActivity extends BaseActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        asyncInflate(R.layout.activity_live_info, (layoutView, id) -> {
            ...
            TextView viewsCount = findViewById(R.id.viewCount);
