...
import com.Alan.BiliClientX.adapter.SettingsAdapter;
import com.Alan.BiliClientX.model.SettingSection;
        ...
        final List<SettingSection> sectionList = new ArrayList<>() {
            {
                ...
                add(new SettingSection("input_string", "开屏文字", "ui_splashtext",
                        getString(R.string.setting_lab_splashtext), "哔哩终端 X\n启动！"));
                ...
                add(new SettingSection("input_float", "接口重试间隔（秒）", SharedPreferencesUtil.API_RETRY_INTERVAL_SECONDS, getString(R.string.setting_lab_api_retry_interval), "0.1"));
                add(new SettingSection("input_int", "接口重试次数", SharedPreferencesUtil.API_RETRY_MAX_TIMES, getString(R.string.setting_lab_api_retry_max_times), "5"));
