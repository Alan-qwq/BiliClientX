...
import com.Alan.BiliClientX.listener.OnItemClickListener;
import com.Alan.BiliClientX.listener.OnItemLongClickListener;
...
public class ListChooseActivity extends BaseActivity {
    ...
    static class Adapter extends RecyclerView.Adapter<com.Alan.BiliClientX.adapter.QualityChooseAdapter.Holder> {
        ...
        @NonNull
        @Override
        public com.Alan.BiliClientX.adapter.QualityChooseAdapter.Holder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
            View view = LayoutInflater.from(this.context).inflate(R.layout.cell_choose, parent, false);
            return new com.Alan.BiliClientX.adapter.QualityChooseAdapter.Holder(view);
        }

        @Override
        public void onBindViewHolder(@NonNull com.Alan.BiliClientX.adapter.QualityChooseAdapter.Holder holder, int position) {
